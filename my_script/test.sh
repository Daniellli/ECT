###
 ...
 # @LastEditTime: 2022-07-16 00:32:59
...
--resume /home/DISCOVER_summer2022/xusc/exp/Cerberus-main/networks/edge_cerberus_v5/checkpoints/edge_cerberus_v52.pth.tar \
--batch-size 1 --workers 40 --gpu-ids "2" --run-id 1 \
2>&1 | tee -a logs/test.log
