...
LastEditTime: 2022-09-05 23:54:53
LastEditors: xushaocong
Description: 
FilePath: /Cerberus-main/reference.py
...
class InferDatasets(Dataset):
    ...
    def __get_img_names(self):
        self.images_name =  sorted(os.listdir(self.data_path))
        
    def __get_list(self):
        self.imgs_list = sorted(glob.glob(self.data_path+"/*.jpg"))
